...
export default {
  ...
  setup() {
    ...
    const isActive = computed(() =>
      ['/asset-management', '/moved-assets-in', '/moved-assets-out', '/scrapped-assets', '/category'].includes(currentUrl.value)
    );
      ...
      <ul class="space-y-4 mt-[53px]">
        ...
        <li class="text-lg">
          <!-- Dropdown Button -->
              ...
              <div class="flex hoverbox-sidebar parenthover-arrow relative">
                <Link href="/asset-management" :class="{ 'font-semibold bg-white pr-[25px] py-1 shadow-lg no-hover': $page.url === '/asset-management' || $page.url === '/moved-assets-in' || $page.url === '/moved-assets-out' || $page.url === '/scrapped-assets' || $page.url === '/category' }">
                ...
                <svg
                  class="w-4 h-4 transition-transform duration-300 mt-[10px] ml-[3px] cursor-pointer absolute right-3 hovereffect-arrow"
                ...
                <!-- Dropdown Menu -->
                <div class="hoverbox-sidebar absolute text-black shadow-lg hoverbox-links-aims">
                    <div>
                      <Link href="/asset-management" class="block px-4 py-2 hover-bg rounded-md text-[15px]" :class="{ 'font-semibold bg-zinc-300 pr-[11px] py-1 shadow-lg no-hover': $page.url === '/asset-management' }">
                        Assign Assets
                      </Link>
                    </div>
                    
                    <div>
                      <Link href="/moved-assets-in" class="block px-4 py-2 hover-bg rounded-md text-[15px]" :class="{ 'font-semibold bg-zinc-300 pr-[11px] py-1 shadow-lg no-hover': $page.url === '/moved-assets-in' || $page.url === '/moved-assets-out' }">
                        Moved Assets
                      </Link>
                    </div>

                    <div>
                      <Link href="/scrapped-assets" class="block px-4 py-2 hover-bg rounded-md text-[15px]" :class="{ 'font-semibold bg-zinc-300 pr-[11px] py-1 shadow-lg no-hover': $page.url === '/scrapped-assets' }">
                        Scrapped Assets
                      </Link>
                    </div>
                    
                    <div>
                      <Link href="/category" class="block px-4 py-2 hover-bg rounded-b-[12px] rounded-t-md text-[15px]" :class="{ 'font-semibold bg-zinc-300 pr-[11px] py-1 shadow-lg no-hover': $page.url === '/category' }">
                        Category
                      </Link>
                    </div>
                  </div>
