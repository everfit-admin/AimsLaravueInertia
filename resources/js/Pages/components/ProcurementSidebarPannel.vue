  ...
  <div class="flex relative group">
    ...
    <div class="bg-gray h-[100%] duration-500 border-r border-black group-hover:w-[220px] w-[290px] -translate-x-[500px] group-hover:translate-x-0 absolute top-0 left-11 z-10">
      <ul class="space-y-4 mt-[53px]">
        <li class="text-lg">
          <Link href="/procurement-dashboard" class="no-hover pl-3" :class="{ 'font-semibold bg-white pl-3 pr-[117px] py-1 shadow-lg no-hover': $page.url === '/procurement-dashboard' }">
            Dashboard
          </Link>
        </li>
        <li class="text-lg">
          <div class="flex">
            <Link href="/department-request" :class="{ 'font-semibold bg-white pr-[25px] py-1 shadow-lg no-hover': $page.url === '/department-request' }">
              <button
          ...
          <div id="dropdown" v-show="isDropdownVisible" class="z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 ml-[14px] mt-[10px]">
            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200">
              <li>
                <Link href="/department-request" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white no-hover">
                  Department Request
                </Link>
              </li>
              <li>
                <Link href="/mov-in" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white no-hover">
                  Purchase Order
                </Link>
              </li>
            </ul>
        ...
        <li class="text-lg">
          <div class="flex">
            <Link href="/ass" :class="{ 'font-semibold bg-white pr-[0px] py-1 shadow-lg no-hover rounded-r-full': $page.url === '/ass' }">
              <button
          ...
          <div id="dropdownMain" v-show="isDropdownVisibleMain" class="z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 ml-[14px] mt-[10px]">
            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200">
              <li>
                <Link href="/asse" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white no-hover">
                  Sample
                </Link>
              </li>
              <li>
